...
namespace IIS.9
{
    ...
    public class Записи : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.9.Заявка fЗаявка;
        
        private IIS.9.Регистр fРегистр;
        ...
        [PropertyStorage(new string[] {
                "Заявка"})]
        [NotNull()]
        public virtual IIS.9.Заявка Заявка
        {
            get
            {
                ...
                IIS.9.Заявка result = this.fЗаявка;
        ...
        [PropertyStorage(new string[] {
                "Регистр"})]
        [NotNull()]
        public virtual IIS.9.Регистр Регистр
        {
            get
            {
                ...
                IIS.9.Регистр result = this.fРегистр;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаписиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаписиE", typeof(IIS.9.Записи));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаписиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаписиL", typeof(IIS.9.Записи));
                }
            }
        }
    }
