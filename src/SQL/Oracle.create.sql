...
(
	...
	"КодРегист" NUMBER(10) NULL,

	"Регистрат" NVARCHAR2(255) NULL,
...
(
	...
	"Отчест" NVARCHAR2(255) NULL,

	"Серия" NUMBER(10) NULL,
...
(
	...
	"Важност" NVARCHAR2(255) NULL,

	"НомЗаяв" NVARCHAR2(255) NULL,
...
(
	...
	"ВремНач" NVARCHAR2(255) NULL,

	"ВремОкон" NVARCHAR2(255) NULL,
...
ALTER TABLE "Записи"
	ADD CONSTRAINT "Записи_FЗаявка_0" FOREIGN KEY ("Заявка") REFERENCES "Заявка" ("primaryKey");

CREATE INDEX "Записи_IЗаявка" on "Записи" ("Заявка");

ALTER TABLE "Записи"
	ADD CONSTRAINT "Записи_FРегистр_0" FOREIGN KEY ("Регистр") REFERENCES "Регистр" ("primaryKey");

CREATE INDEX "Записи_IРегистр" on "Записи" ("Регистр");
